...
<template>
	<div id="privacy">
		...
		<p>
			...
			our system automatically sends a secure verification code to your email. We do not use your registration email for marketing purposes, nor do we
			sell or share it with third parties.
		</p>
		<h3>Contact Form Submissions</h3>
		<p>
			If you choose to reach out to us using our contact form, we collect your name and email address to respond to your specific inquiry. We only use
			this information to communicate directly with you regarding your message. Submitting a contact form will not sign you up for unsolicited marketing
			newsletters.
		</p>
		<h3>How We Use Google Analytics</h3>
		<p>
			We use Google Analytics to help understand how visitors engage with our website. This service uses cookies to collect standard internet log
			information and visitor behavior information in an anonymous form. The information generated by the cookie about your use of the website (including
			IP address) is transmitted to Google. This information is then used to evaluate visitors&#39; use of the website and to compile statistical reports
